...
st.markdown("<h1 style='color: black;text-align:center'>Sistem Rekomendasi Musik</h1>", unsafe_allow_html=True)
client_id = st.text_input("Masukkan Client ID", "71b8a60e3de244d6a14f3ddbb3532b4e")
client_secret = st.text_input("Masukkan Client Secret", "78ad8c957e954325b07e3e37a8c139d5")
client_uri = st.text_input("Masukkan Client URI", "http://localhost:5555/callback")
