...
<head>
    ...
    <title>Website Design For Couple | Using Html, CSS, JavaScript, and GSAP</title>
    <meta name="description" content="Find the best romantic design web to express your love and affection for your boyfriend or girlfriend. This website is dedicated to my girlfriend Alen Priyanto">
    <meta name="keywords" content="website design with gsap,website design for couple, romantic web design, romantic website design">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link title-4 link-style white-font styling-btn text-shadow-pink navBar-hover" aria-current="page" onClick="scrollToBottom()">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link title-4 link-style white-font styling-btn text-shadow-pink navBar-hover" href="error404.html">Blog</a>
            </li>
            <li class="nav-item">
              <a class="nav-link title-4 styling-btn link-style white-font styling-btn text-shadow-pink navBar-hover" href="https://www.instagram.com/roncraftcode/">Order</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="bdr-section2">
            <div class="col">
              ...
              <p class="text-center mx-auto mt-3 sec2pg1">True love is not always easy. It is a journey full of ups and downs, twists and turns, and sometimes even roadblocks. But those who are truly in love know that the journey is worth it.</p>
              <div class="row justify-content-center">
            ...
            <div class="col-lg-7 col-sm-10 text-center bdr">
              <div class="kartu">
                  <div class="kartu-depan raining-bg">
                    ...
                    <p class="sec2pg2">I love you for all that you are, all that you have been and all that you will be.</p>
                  ...
                  <div class="kartu-belakang sunny-bg">
                    ...
                    <p class="sec2pg2">I get jealous because i'm afraid someone is going to make you happier than i do.</p>
...
<div class="Section3">
  <div class="container">
    <div class="row text-center justify-content-center jarak-64">
      ...
      <div class="col-md-8">
        <h2 class="title-2 h2s3">Let's Flashback For a Moment</h2>
      </div>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" tabindex="0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-6">
              <h3 class="title-3 m-0">Our High School Stories</h3>
              <p class="desc-1">Our meeting was at the beginning of 10th grade. Let me retell the story of how we first met. Every time we start a new level in school, there is always something called "MPLS" or an introduction to the school environment. This activity was held to get to know the school environment and get to know other new students. It was during this time that I saw you for the first time, and I liked you. I watched the way you sat, your smile, until I tried to get your attention. Slowly by slowly I began to find out what your name is and began to approach you. Until the time comes and I'm ready to confess my love to you. On August 1, 2017 you officially became my girlfriend.</p>
              <p class="desc-special m-0">"2017, August 1"</p>
            </div>
          </div>
        </div>
        <!-- isi content 2 -->
        <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" tabindex="0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-6">
              <h3 class="title-3 m-0">Our Relationship Struggles</h3>
              <p class="desc-1">If we remember, we experienced quite a lot of relationship struggles during our school days. But in relationships, disagreements are not uncommon. Precisely it can strengthen and bring us closer again. In the past, we still had a hard time dating because we couldn't drive a vehicle. So, our date is 80% in the school area. Thanks to you, I became a studious person and started thinking about my future. Before I met you, I was a lazy person and my only job was to hang out with friends almost every day. Spending money without thinking about the future. Since I was with you, I began to realize that I want to live with you forever. Therefore, I want to change to be a better person in order to be able to live with you in the future.</p>
            </div>
          </div>
        </div>
        <!-- isi content 3 -->
        <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" tabindex="0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-6">
              <h3 class="title-3 m-0">Is There Any Progress in Our Relationship?</h3>
              <p class="desc-1">Yes of course. Each of our problems can be passed over time. Thanks to God for giving us the opportunity to live this relationship. Now we can date wherever we want. We can spend more quality time together than before. The important thing is that we are getting closer to each othe and getting to know each other's families. I know problems in relationships will always arise, but I promise to keep this relationship because I love you. Problems are not a reason to end a relationship.</p>
            </div>
          </div>
        </div>
         <!-- isi content 4 -->
        <div class="tab-pane fade" id="contact-tab1-pane" role="tabpanel" tabindex="0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-6">
              <h3 class="title-3 m-0">About Our Date</h3>
              <p class="desc-1">In this segment, I'll tell you about the things I love about dating you. I like to pick you up from your house, because I can see your pretty smile. I like that we go together to our date place. I like us holding hands when we go out with you. I like to eat the food I like while looking at you in front of you. I love the ambiguity we both have when it comes to jokes. I like watching movies on dates with you because I can hold hands and lean on you. After watching, I like it when we buy dessert or other snacks. The last one is that I like that we spend time communicating until evening until I have to go home. What I don't like is when I have to part with you because we will meet again next week.
            </div>
          </div>
        </div>
         <!-- isi content 5 -->
        <div class="tab-pane fade" id="contact-tab2-pane" role="tabpanel" tabindex="0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-1"></div>
            <div class="col-lg-6">
              <h3 class="title-3 m-0">My Message For You Alen</h3>
              <p class="desc-1">Thank you for accepting me as your partner. I am so grateful to have lived these 5 years with you. Chat every day, Dating every week. I once imagined that I had never met you, wasting money and didn't know the meaning of saving, was lazy to study, and had no meaning in life. With your presence, I found my purpose in life. I want to try so that later in the future I can live with you forever. Thank you for being a patient, caring and loving woman. I'm here to try to be more patient and be able to make you my queen.</p>
              <p class="desc-special m-0">Promise to Love and Take Care of You </p>
...
<div class="Section4">
    <div class="container">
      <h2 class="title-2 jarak-64 text-center">Lets We Fly Together Shall We?</h2>
      <div class="row hide-in-mobile">
        ...
        <div class="col-lg-6 slide1">
          <p class="desc-special1 m-0">Since 2017</p>
          <p class="desc-special2 m-0">We met at school in high school</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-mobile">
        ...
        <div class="col-lg-6  text-end slide2">
          <p class="desc-special1 m-0">2018, August 1</p>
          <p class="desc-special2 m-0">Our One Year Anniversary</p>
        </div>
      </div>

      <div class="row hide-in-mobile">
        <div class="col-lg-6 slide3">
          <p class="desc-special1 m-0">2019, August 1</p>
          <p class="desc-special2 m-0">Our Two Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-mobile">
        ...
        <div class="col-lg-6 text-end slide4">
          <p class="desc-special1 m-0">2020, August 1</p>
          <p class="desc-special2 m-0">Our Three Year Anniversary</p>
        </div>
      </div>

      <div class="row hide-in-mobile">
        <div class="col-lg-6 slide5">
          <p class="desc-special1 m-0">2021, August 1</p>
          <p class="desc-special2 m-0">Our Four Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-mobile">
        ...
        <div class="col-lg-6  text-end slide6">
          <p class="desc-special1 m-0">2022, August 1</p>
          <p class="desc-special2 m-0">Our Five Year Anniversary</p>
        </div>
      </div>

      <div class="row hide-in-mobile">
        <div class="col-lg-6 slide7">
          <p class="desc-special1 m-0">2023, August 1</p>
          <p class="desc-special2 m-0">Our Six Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-mobile">
        ...
        <div class="col-lg-6 text-end slide8">
          <p class="desc-special1 m-0">To be Continue...</p>
        </div>
      </div>
      ...
      <div class="row hide-in-dekstop">
        ...
        <div class="col-lg-6 slide9">
          <p class="desc-special1 m-0">Since 2017</p>
          <p class="desc-special2 ">We met at school in high school</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-dekstop">
        ...
        <div class="col-lg-6  text-end slide10">
          <p class="desc-special1 m-0">2018, August 1</p>
          <p class="desc-special2 ">Our One Year Anniversary</p>
        </div>
      </div>
      ...
      <div class="row hide-in-dekstop">
        <div class="col-lg-6 slide11">
          <p class="desc-special1 m-0">2019, August 1</p>
          <p class="desc-special2 ">Our Two Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-dekstop">
        ...
        <div class="col-lg-6 text-end slide12">
          <p class="desc-special1 m-0">2020, August 1</p>
          <p class="desc-special2">Our Three Year Anniversary</p>
        </div>
      </div>
      ...
      <div class="row hide-in-dekstop">
        <div class="col-lg-6 slide13">
          <p class="desc-special1 m-0">2021, August 1</p>
          <p class="desc-special2 ">Our Four Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-dekstop">
        ...
        <div class="col-lg-6  text-end slide14">
          <p class="desc-special1 m-0">2022, August 1</p>
          <p class="desc-special2">Our Five Year Anniversary</p>
        </div>
      </div>
      ...
      <div class="row hide-in-dekstop">
        <div class="col-lg-6 slide15">
          <p class="desc-special1 m-0">2023, August 1</p>
          <p class="desc-special2 ">Our Six Year Anniversary</p>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row hide-in-dekstop">
        ...
        <div class="col-lg-6 text-end slide16">
          <p class="desc-special1">To be Continue...</p>
        </div>
      </div>
    </div>
</div>
  ...
  <div class="container container-footer-bg" style="position: relative;" id="footer-buble">
    <div class="row gx-0 gx-sm-3 mt-lg-0 mt-5" id="moving-up">
      <div class="col-lg-3 col-md-4 my-lg-5 col-6 line-left col1" style="overflow: hidden;">
        ...
        <a href="https://www.instagram.com/roncraftcode/" class="decoration-none white-font"><P class="title-4 mb-sm-3 mb-2 opacity-50persen">Business</P></a>
        <a href="https://discordapp.com/users/476009868742885407/" class="decoration-none white-font"><P class="title-4 mb-sm-3 mb-2 opacity-50persen">Contact Me</P></a>
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-6 my-lg-5 line-left col2" style="overflow: hidden;">
        ...
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-sm-3 mb-2 opacity-50persen">Portfolio</P></a>
        <a href="https://www.instagram.com/roncraftcode/" class="decoration-none white-font"><P class="title-4 mb-sm-3 mb-2 opacity-50persen">Order</P></a>
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-sm-3 mb-2 opacity-50persen">Know More..</P></a>
      </div>

      <div class="col-lg-3 col-md-4 col-6 my-lg-5 line-left hide-small-mobile col3" style="overflow: hidden;">
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-3 opacity-50persen">Other Page</P></a>
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-3 opacity-50persen">Other Page</P></a>
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-3 opacity-50persen">Other Page</P></a>
        <a href="error404.html" class="decoration-none white-font"><P class="title-4 mb-3 opacity-50persen">Other Page</P></a>
      </div>
      <div class="col-lg-3 col-md-4 my-lg-5 line-left hide-in-mobile col4" style="overflow: hidden;">
        <div class="wrapper-footer">
          <h2 class="title-4 mb-2 white-font" style="opacity: 50%;">About Me as Creator</h2>
          <div class="mb-4">
          ...
          <h2 class="title-4 mb-2 white-font" style="opacity: 50%;">About My Girlfriend</h2>
          <div class="mb-3">
